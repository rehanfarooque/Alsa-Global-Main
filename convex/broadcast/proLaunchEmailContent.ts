...
export const PRO_LAUNCH_FROM = "Elie from AlsaGlobal <news@worldmonitor.app>";
export const PRO_LAUNCH_REPLY_TO = "elie@worldmonitor.app";
export const PRO_LAUNCH_SUBJECT = "You waitlisted AlsaGlobal PRO. It's now live.";
...
export const PRO_LAUNCH_PHYSICAL_ADDRESS = "AlsaGlobal FZ LLC, Dubai - United Arab Emirates";
 ...
 */
export const PRO_LAUNCH_TEXT = `I'm Elie, founder of AlsaGlobal. PRO launched today (/). I'm writing because you signed up a month ago, when the product was smaller and different.

Here's what it is now.

AlsaGlobal stopped being only a real-time monitoring dashboard, though it still excels at that. It's also a research tool now. It tracks what's happening, and it forecasts what happens next: scenario probabilities on conflicts, market reactions to headlines, supply-chain shock paths, country stability trajectories. You read the present and stress-test the future in the same place.
...
Native AI context. MCP server plus a 27-endpoint REST API — full docs at / Plug it into Claude, ChatGPT, Cursor, or anything you're building.
...
<p>I'm Elie, founder of AlsaGlobal. <a href="/" style="color:#0066cc;">PRO launched today</a>. I'm writing because you signed up a month ago, when the product was smaller and different.</p>
<p>Here's what it is now.</p>
<p>AlsaGlobal stopped being only a real-time monitoring dashboard, though it still excels at that. It's also a research tool now. It tracks what's happening, and it forecasts what happens next: scenario probabilities on conflicts, market reactions to headlines, supply-chain shock paths, country stability trajectories. You read the present and stress-test the future in the same place.</p>
...
<p><strong>Native AI context.</strong> MCP server plus a 27-endpoint REST API — <a href="/" style="color:#0066cc;">full docs</a>. Plug it into Claude, ChatGPT, Cursor, or anything you're building.</p>
<p>Also included:</p>
...
<a href="/" style="display:inline-block;background:#111;color:#ffffff;text-decoration:none;padding:14px 28px;border-radius:6px;font-weight:600;">Upgrade to PRO with EARLYWM30 →</a>
</p>
