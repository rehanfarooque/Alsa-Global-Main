...
description: "Dynamic client registration, authorization, and token exchange endpoints that back the AlsaGlobal MCP server."
---

AlsaGlobal runs a minimal OAuth 2.1 authorization server whose only client-facing purpose today is **granting access to the MCP server** at `/api/mcp`. It implements:
