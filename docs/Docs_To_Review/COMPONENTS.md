# Component Documentation — AlsaGlobal
...
AlsaGlobal's UI is built entirely with **vanilla TypeScript** — no React, Vue, or
...
AlsaGlobal ships two independent map renderers and an adapter that picks the
