---
title: "Latest Brief"
description: "The AlsaGlobal daily AI intelligence brief, surfaced in the dashboard as a single card that links to a signed magazine-style reader and shareable public URL."
---

The **Latest Brief** panel is the dashboard surface for the AlsaGlobal Brief — an AI-generated daily intelligence digest that synthesises the day's most significant events into a structured, source-attributed read. The composer runs as a Railway job once per day per user; the panel simply mirrors whatever brief exists for the signed-in reader at the moment they open the dashboard.
