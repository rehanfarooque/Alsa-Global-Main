...
- Panel prefers the hydrated bootstrap payload first (`getHydratedData()`) and falls back to a fresh RPC call — the standard AlsaGlobal "one bootstrap, no duplicate fetch" pattern.
