...
- **Connect your own agent** via the [MCP server](/mcp-server) — Claude, Cursor, and other MCP clients can call curated AlsaGlobal tools over OAuth 2.1 or a direct API key
...
AlsaGlobal is open source under [AGPL-3.0](/license). Free for personal, educational, and research use. Commercial use requires a [separate license](/license#commercial-use-requires-a-separate-license).
