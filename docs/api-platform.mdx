...
description: "Bootstrap, health, versioning, cache-purge, and user preferences — the plumbing endpoints every AlsaGlobal client talks to."
---
...
- **Auth**: browser origin OR `X-AlsaGlobal-Key`
...
- `X-AlsaGlobal-Desktop-Timestamp`: Unix epoch milliseconds, within 5 minutes of server time.
- `X-AlsaGlobal-Desktop-Signature`: `sha256=<hex HMAC-SHA256>`.
