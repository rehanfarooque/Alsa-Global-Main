---
title: "Quickstart"
description: "Make your first AlsaGlobal API call in under a minute — curl, JavaScript, and Python."
---
...
const res = await fetch(
  ...
  { headers: { 'X-AlsaGlobal-Key': process.env.WM_KEY } }
);
...
r = httpx.get(
    ...
    headers={"X-AlsaGlobal-Key": os.environ["WM_KEY"]},
)
r.raise_for_status()
print(r.json())
```
