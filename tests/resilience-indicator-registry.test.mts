...
import { RESILIENCE_DIMENSION_ORDER } from '../server/alsaglobal/resilience/v1/_dimension-scorers.ts';
import { INDICATOR_REGISTRY } from '../server/alsaglobal/resilience/v1/_indicator-registry.ts';
import type { IndicatorSpec } from '../server/alsaglobal/resilience/v1/_indicator-registry.ts';
