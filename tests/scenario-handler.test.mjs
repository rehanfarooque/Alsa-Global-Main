...
describe('ScenarioService handlers', () => {
  beforeEach(async () => {
    ...
    const runMod = await import('../server/alsaglobal/scenario/v1/run-scenario.ts');
    const statusMod = await import('../server/alsaglobal/scenario/v1/get-scenario-status.ts');
    const templatesMod = await import('../server/alsaglobal/scenario/v1/list-scenario-templates.ts');
    ...
    const gen = await import('../src/generated/server/alsaglobal/scenario/v1/service_server.ts');
