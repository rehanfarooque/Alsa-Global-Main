...
function loadRelayFunctions() {
  ...
  const CHROME_UA = 'AlsaGlobal-Test-UA';
...
describe('getRelayHeaders — no auth', () => {
  ...
  it('aviation User-Agent override works', () => {
    const h = getRelayHeaders({ 'User-Agent': 'AlsaGlobal-Server/1.0' });
    assert.equal(h['User-Agent'], 'AlsaGlobal-Server/1.0');
  });
});
...
describe('relay.ts — consumer import verification', () => {
  const consumers = [
    { file: 'server/alsaglobal/aviation/v1/_shared.ts', importPath: '../../../_shared/relay' },
    { file: 'server/alsaglobal/intelligence/v1/_relay.ts', importPath: '../../../_shared/relay' },
    { file: 'server/alsaglobal/research/v1/list-tech-events.ts', importPath: '../../../_shared/relay' },
    { file: 'server/alsaglobal/maritime/v1/get-vessel-snapshot.ts', importPath: '../../../_shared/relay' },
    { file: 'server/alsaglobal/market/v1/_shared.ts', importPath: '../../../_shared/relay' },
    { file: 'server/alsaglobal/news/v1/list-feed-digest.ts', importPath: '../../../_shared/relay' },
    { file: 'server/alsaglobal/military/v1/list-military-flights.ts', importPath: '../../../_shared/relay' },
  ];
  ...
  it('no local getRelayBaseUrl/getRelayHeaders/getRelayRequestHeaders definitions in server/ (except _shared/relay.ts)', () => {
    const dupeFiles = [
      'server/alsaglobal/aviation/v1/_shared.ts',
      'server/alsaglobal/intelligence/v1/_relay.ts',
      'server/alsaglobal/research/v1/list-tech-events.ts',
      'server/alsaglobal/maritime/v1/get-vessel-snapshot.ts',
      'server/alsaglobal/market/v1/_shared.ts',
      'server/alsaglobal/news/v1/list-feed-digest.ts',
      'server/alsaglobal/military/v1/list-military-flights.ts',
    ];
  ...
  it('military list-military-flights.ts uses getRelayBaseUrl() not raw WS_RELAY_URL + /opensky', () => {
    const src = readFileSync(resolve('server/alsaglobal/military/v1/list-military-flights.ts'), 'utf-8');
    assert.ok(
