...
import { adaptTransition } from '../server/alsaglobal/intelligence/v1/get-regime-history';

const __dirname = dirname(fileURLToPath(import.meta.url));
const root = resolve(__dirname, '..');

const handlerSrc = readFileSync(
  resolve(root, 'server/alsaglobal/intelligence/v1/get-regime-history.ts'),
  'utf-8',
);
...
const protoSrc = readFileSync(
  resolve(root, 'proto/alsaglobal/intelligence/v1/get_regime_history.proto'),
  'utf-8',
);
