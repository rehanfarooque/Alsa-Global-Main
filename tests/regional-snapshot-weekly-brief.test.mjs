...
const handlerSrc = readFileSync(resolve(root, 'server/alsaglobal/intelligence/v1/get-regional-brief.ts'), 'utf-8');
const handlerIndexSrc = readFileSync(resolve(root, 'server/alsaglobal/intelligence/v1/handler.ts'), 'utf-8');
...
const protoSrc = readFileSync(resolve(root, 'proto/alsaglobal/intelligence/v1/get_regional_brief.proto'), 'utf-8');
const serviceProtoSrc = readFileSync(resolve(root, 'proto/alsaglobal/intelligence/v1/service.proto'), 'utf-8');
