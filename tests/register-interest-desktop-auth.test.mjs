...
describe('LeadsService.registerInterest desktop auth', () => {
  beforeEach(async () => {
    ...
    const mod = await import('../server/alsaglobal/leads/v1/register-interest.ts');
    ...
    const gen = await import('../src/generated/server/alsaglobal/leads/v1/service_server.ts');
