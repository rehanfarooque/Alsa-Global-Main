 ...
 *   - server/alsaglobal/cyber/v1/_shared.ts
 *   - server/alsaglobal/news/v1/_shared.ts  (+ dedup.mjs + hash.ts)
 *   - server/alsaglobal/infrastructure/v1/get-cable-health.ts
 *
 * NOTE: server/alsaglobal/military/v1/get-usni-fleet-report.ts has many useful
...
import {
  ...
  SEVERITY_RANK,
  type RawThreat,
} from '../server/alsaglobal/cyber/v1/_shared.ts';

// ---------------------------------------------------------------------------
// News domain helpers
// ---------------------------------------------------------------------------
import { deduplicateHeadlines } from '../server/alsaglobal/news/v1/dedup.mjs';
import { buildArticlePrompts, hashString } from '../server/alsaglobal/news/v1/_shared.ts';
...
import {
  ...
  processNgaSignals,
  computeHealthMap,
} from '../server/alsaglobal/infrastructure/v1/get-cable-health.ts';
