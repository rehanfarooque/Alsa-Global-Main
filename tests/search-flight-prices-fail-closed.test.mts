...
} from '../src/generated/server/alsaglobal/aviation/v1/service_server.ts';
import { searchFlightPrices } from '../server/alsaglobal/aviation/v1/search-flight-prices.ts';
