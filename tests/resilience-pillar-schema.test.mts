...
} from '../server/alsaglobal/resilience/v1/_dimension-scorers.ts';
import {
  PILLAR_DOMAINS,
  PILLAR_ORDER,
  PILLAR_WEIGHTS,
...
} from '../server/alsaglobal/resilience/v1/_pillar-membership.ts';
import type { ResilienceDomain } from '../src/generated/server/alsaglobal/resilience/v1/service_server.ts';
