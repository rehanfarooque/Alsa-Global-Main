...
import { backtestStock } from '../server/alsaglobal/market/v1/backtest-stock.ts';
import { listStoredStockBacktests } from '../server/alsaglobal/market/v1/list-stored-stock-backtests.ts';
import { MarketServiceClient } from '../src/generated/client/alsaglobal/market/v1/service_client.ts';
