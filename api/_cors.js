...
export function getCorsHeaders(req, methods = 'GET, OPTIONS') {
  ...
  return {
    ...
    'Access-Control-Allow-Headers': 'Content-Type, Authorization, X-AlsaGlobal-Key, X-Api-Key, X-Widget-Key, X-Pro-Key, X-AlsaGlobal-Desktop-Timestamp, X-AlsaGlobal-Desktop-Signature',
