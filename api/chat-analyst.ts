...
import { assembleAnalystContext } from '../server/alsaglobal/intelligence/v1/chat-analyst-context';
import { buildAnalystSystemPrompt } from '../server/alsaglobal/intelligence/v1/chat-analyst-prompt';
import { buildActionEvents } from '../server/alsaglobal/intelligence/v1/chat-analyst-actions';
  ...
  if (req.method === 'OPTIONS') {
    return new Response(null, {
      ...
      headers: {
        ...
        'Access-Control-Allow-Headers': 'Content-Type, Authorization, X-AlsaGlobal-Key, X-Api-Key',
      },
    });
  }
