...
export const RPC_TOOLS: ToolDef[] = [
  {
    ...
    _execute: async (params, base, context) => {
      const UA = 'alsaglobal-mcp-edge/1.0';
  ...
  },
  {
    ...
    _execute: async (params, base, context) => {
      ...
      const res = await fetch(url, {
        headers: { ...auth, 'User-Agent': 'alsaglobal-mcp-edge/1.0' },
  ...
  },
  {
    ...
    _execute: async (params, base, context) => {
      ...
      const res = await fetch(url, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json', ...auth, 'User-Agent': 'alsaglobal-mcp-edge/1.0' },
        body,
