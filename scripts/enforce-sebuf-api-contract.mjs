 ...
 *      generated service_server under src/generated/server/alsaglobal/<snake_domain>/v<N>/.
...
//      e.g. /api/v2/shipping/*).
// Both map to src/generated/server/alsaglobal/<snake_domain>/v<N>/.
  ...
  if (gatewayMatch) {
    ...
    if (!existsSync(expectedServer)) {
      violation(
        ...
        `Expected ${relative(ROOT, expectedServer)}. Either regenerate (cd proto && buf generate), restore the proto under proto/alsaglobal/${snakeDomain}/v${version}/service.proto, or delete this orphaned gateway.`,
      );
    }
    continue;
  }
