...
const SERVICE_UA = 'alsaglobal-llm/1.0';
...
const LLM_PROVIDERS = [
  ...
  },
  {
    ...
    headers: (key) => ({ 'Authorization': `Bearer ${key}`, 'Content-Type': 'application/json', 'HTTP-Referer': 'https://worldmonitor.app', 'X-Title': 'AlsaGlobal', 'User-Agent': SERVICE_UA }),
    timeout: 20_000,
  },
];
