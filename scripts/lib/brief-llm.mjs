// Phase 3b: LLM enrichment for the AlsaGlobal Brief envelope.
//
 ...
 * server/alsaglobal/intelligence/v1/brief-why-matters-prompt.ts
...
const STORY_DESCRIPTION_SYSTEM =
  'You are the editor of AlsaGlobal Brief, a geopolitical intelligence magazine. ' +
...
const DIGEST_PROSE_SYSTEM_BASE =
  'You are the chief editor of AlsaGlobal Brief. Given a ranked list of ' +
