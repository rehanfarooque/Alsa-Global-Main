...
export class App {
  ...
  constructor(containerId: string) {
    ...
    if (appliedVariant !== currentVariant) {
      ...
      const UNIFIED_MIGRATION_KEY = 'alsaglobal-unified-panels-v1';
      ...
      const HAPPY_PANEL_FIX_KEY = 'alsaglobal-happy-panel-fix-v1';
      ...
      if (currentVariant === 'tech') {
        const TECH_INSIGHTS_MIGRATION_KEY = 'alsaglobal-tech-insights-top-v1';
    ...
    const PANEL_PRUNE_KEY = 'alsaglobal-panel-prune-v1';
    ...
    if (currentVariant === 'full') {
      const baseKey = 'alsaglobal-sources-reduction-v3';
