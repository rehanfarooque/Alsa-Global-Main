...
export const DESKTOP_PARITY_FEATURES: DesktopParityFeature[] = [
  ...
  },
  {
    ...
    apiHandlers: ['server/alsaglobal/conflict/v1/handler.ts', 'server/alsaglobal/infrastructure/v1/handler.ts', 'server/alsaglobal/cyber/v1/handler.ts', 'server/alsaglobal/maritime/v1/handler.ts', 'server/alsaglobal/military/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/alsaglobal/news/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/alsaglobal/market/v1/handler.ts'],
    locality: 'fully-local',
  ...
  },
  {
    ...
    apiHandlers: ['server/alsaglobal/military/v1/handler.ts'],
    locality: 'api-key',
