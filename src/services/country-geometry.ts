...
/** Optional higher-resolution boundary overrides. Disabled for AlsaGlobal self-host — set to '' to skip. */
...
async function ensureLoaded(): Promise<void> {
  ...
  loadPromise = (async () => {
    ...
    try {
      ...
      // Apply optional higher-resolution boundary overrides. Disabled in AlsaGlobal.
      try {
        if (!COUNTRY_OVERRIDES_URL) {
          // Skip — no override URL configured
        } else {
