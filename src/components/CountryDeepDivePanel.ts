...
import type { ComputeEnergyShockScenarioResponse, ProductImpact } from '@/generated/client/alsaglobal/intelligence/v1/service_client';
  ...
  private async loadDisruptionsForCountry(iso2: string): Promise<void> {
    try {
      const { SupplyChainServiceClient } = await import(
        '@/generated/client/alsaglobal/supply_chain/v1/service_client'
      );
