 ...
 *
 * Matches AlsaGlobal's MapContainer API so it can be used as a drop-in
...
import type { ImageryScene } from '@/generated/server/alsaglobal/imagery/v1/service_server';
import { isAllowedPreviewUrl } from '@/utils/imagery-preview';
import { getCategoryStyle } from '@/services/webcams';
import { pinWebcam, isPinned } from '@/services/webcams/pinned-store';
import type { WebcamEntry, WebcamCluster } from '@/generated/client/alsaglobal/webcam/v1/service_client';
import type { TrafficAnomaly as ProtoTrafficAnomaly, DdosLocationHit } from '@/generated/client/alsaglobal/infrastructure/v1/service_client';
...
export class GlobeMap {
  ...
  private createLayerToggles(): void {
    ...
    authorBadge.textContent = '© AlsaGlobal';
