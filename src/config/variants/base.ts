...
export const STORAGE_KEYS = {
  panels: 'alsaglobal-panels',
  monitors: 'alsaglobal-monitors',
  mapLayers: 'alsaglobal-layers',
  disabledFeeds: 'alsaglobal-disabled-feeds',
  ...
  disabledFeedsSchema: 'alsaglobal-disabled-feeds-schema',
  liveChannels: 'alsaglobal-live-channels',
  mapMode: 'alsaglobal-map-mode',          // 'flat' | 'globe'
  activeChannel: 'alsaglobal-active-channel',
  webcamPrefs: 'alsaglobal-webcam-prefs',
} as const;
