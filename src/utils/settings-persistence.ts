...
const SETTINGS_KEY_PREFIXES: readonly string[] = [
  ...
  'alsaglobal-live-channels',
  'alsaglobal-active-channel',
  'alsaglobal-runtime-feature-toggles',
  'wm-globe-render-scale',
  'wm-live-streams-always-on',
  'alsaglobal-webcam-prefs',
  'wm-map-theme:',
  'map-height',
  'map-pinned',
...
export function exportSettings(): void {
  ...
  const exportData: ExportedSettings = {
    ...
    variant: localStorage.getItem('alsaglobal-variant') || 'full',
    data,
  };
