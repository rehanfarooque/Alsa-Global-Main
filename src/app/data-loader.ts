...
import type { ListFeedDigestResponse } from '@/generated/client/alsaglobal/news/v1/service_client';
import type { GetSectorSummaryResponse, ListMarketQuotesResponse, ListCommodityQuotesResponse } from '@/generated/client/alsaglobal/market/v1/service_client';
import type { SectorValuation } from '@/components/MarketPanel';
import { mountCommunityWidget } from '@/components/CommunityWidget';
import { ResearchServiceClient } from '@/generated/client/alsaglobal/research/v1/service_client';
import {
  MarketPanel,
  StockAnalysisPanel,
  StockBacktestPanel,
...
import type { NewsItem as ProtoNewsItem, ThreatLevel as ProtoThreatLevel } from '@/generated/client/alsaglobal/news/v1/service_client';
...
export class DataLoaderManager implements AppModule {
  ...
  private readonly digestRequestTimeoutMs = 60000;
  private readonly digestBreakerCooldownMs = 30 * 1000;
  ...
  private async _collectRegimeContext(): Promise<RegimeMacroContext | undefined> {
    try {
      ...
      const { MarketServiceClient } = await import('@/generated/client/alsaglobal/market/v1/service_client');
  ...
  private async _collectYieldCurveContext(): Promise<YieldCurveContext | undefined> {
    try {
      const { EconomicServiceClient } = await import('@/generated/client/alsaglobal/economic/v1/service_client');
      const { getRpcBaseUrl } = await import('@/services/rpc-client');
  ...
  async loadForecasts(): Promise<void> {
    try {
      const hydrated = getHydratedData('forecasts') as { predictions?: import('@/generated/client/alsaglobal/forecast/v1/service_client').Forecast[] } | undefined;
  ...
  async loadIntelligenceSignals(): Promise<void> {
    ...
    const hydratedUcdp = getHydratedData('ucdpEvents') as import('@/generated/client/alsaglobal/conflict/v1/service_client').ListUcdpEventsResponse | undefined;
  ...
  async loadEconomicStress(): Promise<void> {
    try {
      ...
      const hydrated = getHydratedData('economicStress') as import('@/generated/client/alsaglobal/economic/v1/service_client').GetEconomicStressResponse | undefined;
