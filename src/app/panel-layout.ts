  ...
  async renderLayout(): Promise<void> {
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        ...
        // AlsaGlobal: cross-domain hrefs disabled (we run a single deployment).
        // Clicking a variant switches localStorage value and reloads same origin.
        ...
        return `
          ...
          <span class="logo">AlsaGlobal</span><span class="logo-mobile">AlsaGlobal</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">AlsaGlobal</span>
        ...
        <div class="mobile-menu-footer-links">
          <a href="https://github.com/koala73/worldmonitor" target="_blank" rel="noopener" title="Source code (AGPL-3.0)">Source</a>
        </div>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">AlsaGlobal</span>
        ...
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} AlsaGlobal</span>
      </footer>
    `;
