...
} from '../../../../src/generated/server/alsaglobal/leads/v1/service_server';
import { ApiError, ValidationError } from '../../../../src/generated/server/alsaglobal/leads/v1/service_server';
...
export const DESKTOP_AUTH_TIMESTAMP_HEADER = 'x-alsaglobal-desktop-timestamp';
export const DESKTOP_AUTH_SIGNATURE_HEADER = 'x-alsaglobal-desktop-signature';
...
async function sendConfirmationEmail(email: string, referralCode: string): Promise<void> {
  const referralLink = `/`;
  const shareText = encodeURIComponent("I just joined the AlsaGlobal Pro waitlist \u2014 real-time global intelligence powered by AI. Join me:");
  ...
  const telegramShare = `https://t.me/share/url?url=${shareUrl}&text=${encodeURIComponent('Join the AlsaGlobal Pro waitlist:')}`;
  ...
  try {
    const resendRes = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        to: [email],
        subject: "You\u2019re on the AlsaGlobal Pro waitlist",
        html: `
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0a; color: #e0e0e0;">
              ...
              <table cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto 32px;">
                <tr>
                  <td style="width: 40px; height: 40px; vertical-align: middle;">
                    <img src="https://www.worldmonitor.app/favico/android-chrome-192x192.png" width="40" height="40" alt="AlsaGlobal" style="border-radius: 50%; display: block;" />
                  </td>
            ...
            <div style="border-top: 1px solid #1a1a1a; padding: 24px 32px; text-align: center;">
              <div style="margin-bottom: 16px;">
                ...
                <a href="/" style="color: #666; text-decoration: none; font-size: 12px; margin: 0 12px;">Pro Waitlist</a>
              </div>
              <p style="font-size: 11px; color: #444; margin: 0; line-height: 1.6;">
                AlsaGlobal \u2014 Real-time intelligence for a connected world.<br />
